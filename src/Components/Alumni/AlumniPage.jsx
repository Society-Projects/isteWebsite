  ...
  return (
    <>
      <SEO
        ...
        description="Connect with the esteemed alumni network of ISTE Thapar Chapter (TIET) leading innovation across global tech leaders."
        keywords="tiet, iste, college society, thapar chapter, alumni, alumni network, thapar graduates"
      />
